            ...
            <div class="modal-body">
                <form id="tambahPaketUmrahForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="periode-bulan">Company Name</label>
                        <input class="form-control" type="text" id="estimasi-harga-tiket" placeholder="Company Name">
                        <input type="hidden" id="harga-tiket-hidden" name="estimasi_harga_tiket">
                    </div>

                    <!-- Tanggal Berangkat Field -->
                    <div class="form-group">
                        <label for="tanggal-berangkat">Address</label>
                        <input class="form-control" type="text" id="estimasi-harga-tiket" placeholder="Address">
                        <input type="hidden" id="harga-tiket-hidden" name="estimasi_harga_tiket">
                    </div>

                    <!-- Tanggal Berangkat Field -->
                    <div class="form-group">
                        <label for="tanggal-berangkat">No Telepon</label>
...
<script>
    // URL dari GitHub Gist
    const url =
        'https://gist.githubusercontent.com/anubhavshrimal/75f6183458db8c453306f93521e93d37/raw/7e4ae7a73220e972d131815dc6fe77cf621847bc/CountryCodes.json';

    // Ambil data dari GitHub Gist
    fetch(url)
